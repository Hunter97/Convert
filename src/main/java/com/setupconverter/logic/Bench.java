...
public final class Bench {
    ...
    private void initializeParamMaps() {
        ...
        m_inputParams.put( "Input7Type=", Input.PARK_HEAD_1.getValue() );
        m_inputParams.put( "Input8Type=", Input.PARK_HEAD_2.getValue() );
        m_inputParams.put( "Input9Type=", Input.TORCH_COLLISION.getValue() );
        m_inputParams.put( "Input10Type=", Input.X_POS_OT.getValue() );
        m_inputParams.put( "Input11Type=", Input.Y_POS_OT.getValue() );
        m_inputParams.put( "Input12Type=", Input.DRIVE_DISABLED.getValue() );
        m_inputParams.put( "Input13Type=", Input.CUT_SENSE_1.getValue() );
        m_inputParams.put( "Input14Type=", Input.CUT_SENSE_2.getValue() );
