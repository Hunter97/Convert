...
public final class Bench {
    ...
    private void initializeParamMaps() {
        ...
        // Inputs
        m_inputParams.put( "Input10Number=", 12 );
        ...
        m_inputParams.put( "Input100Number=", 9 );
        m_inputParams.put( "Input103Number=", 6 );
        m_inputParams.put( "Input105Number=", 4 );
        m_inputParams.put( "Input106Number=", 13 );
        m_inputParams.put( "Input107Number=", 14 );
        m_inputParams.put( "Input126Number=", 7 );
        m_inputParams.put( "Input127Number=", 8 );
        ...
        m_inputParams.put( "Input7Type=", INPUT_NUM.PARK_HEAD_1.getValue() );
        m_inputParams.put( "Input8Type=", INPUT_NUM.PARK_HEAD_2.getValue() );
        m_inputParams.put( "Input9Type=", INPUT_NUM.TORCH_COLLISION.getValue() );
        m_inputParams.put( "Input10Type=", INPUT_NUM.X_POS_OT.getValue() );
        m_inputParams.put( "Input11Type=", INPUT_NUM.Y_POS_OT.getValue() );
        m_inputParams.put( "Input12Type=", INPUT_NUM.DRIVE_DISABLED.getValue() );
        m_inputParams.put( "Input13Type=", INPUT_NUM.CUT_SENSE_1.getValue() );
        m_inputParams.put( "Input14Type=", INPUT_NUM.CUT_SENSE_2.getValue() );
        ...
        m_outputParams.put( "Output55Number=", 24 );
        m_outputParams.put( "Output57Number=", 3 );
        m_outputParams.put( "Output58Number=", 1 );
        m_outputParams.put( "Output197Number=", 18 );
        m_outputParams.put( "Output198Number=", 17 );
        ...
        m_outputParams.put( "Output17Type=", OUTPUT.CUT_CONTROL2.getValue() );
        m_outputParams.put( "Output18Type=", OUTPUT.CUT_CONTROL1.getValue() );
        ...
        m_thcParams.put( "DGain=", 20 );
        m_thcParams.put( "FGain=", 100 );
        ...
        m_thcParams.put( "EncoderCounts(english)=", 8192 );
        m_thcParams.put( "EncoderCounts(metric)=", 323 );
        m_thcParams.put( "DriveType=", 0 );
        m_thcParams.put( "DACPolarity=", 1 );
        ...
        // Bevel Axes
        m_bevelParams.put( "PGain=", 20 );
        m_bevelParams.put( "IGain=", 0 );
        m_bevelParams.put( "DGain=", 20 );
        m_bevelParams.put( "FGain=", 100 );
        m_bevelParams.put( "ServoErrTolerance(degrees)=", 90 );
        m_bevelParams.put( "EncoderCounts(revs)=", 8192 );
        m_bevelParams.put( "DriveType=", 0 );
        m_bevelParams.put( "DACPolarity=", 0 );
        m_bevelParams.put( "EncoderPolarity=", 1 );
        ...
        // Axis 1, 2, and 6
        m_axesParams.put( "PGain=", 20 );
        m_axesParams.put( "IGain=", 0 );
        m_axesParams.put( "DGain=", 20 );
        m_axesParams.put( "FGain=", 100 );
        m_axesParams.put( "VGain=", 0 );
        m_axesParams.put( "PGain2=", 20 );
        m_axesParams.put( "IGain2=", 0 );
        m_axesParams.put( "DGain2=", 20 );
        m_axesParams.put( "FGain2=", 100 );
        m_axesParams.put( "VGain2=", 0 );
        m_axesParams.put( "PGain3=", 20 );
        m_axesParams.put( "IGain3=", 0 );
        m_axesParams.put( "DGain3=", 20 );
        m_axesParams.put( "FGain3=", 100 );
        m_axesParams.put( "VGain3=", 0 );
        m_axesParams.put( "PGain4=", 20 );
        m_axesParams.put( "IGain4=", 0 );
        m_axesParams.put( "DGain4=", 20 );
        m_axesParams.put( "FGain4=", 100 );
        m_axesParams.put( "VGain4=", 0 );
        m_axesParams.put( "PGain5=", 20 );
        m_axesParams.put( "IGain5=", 0 );
        m_axesParams.put( "DGain5=", 20 );
        m_axesParams.put( "FGain5=", 100 );
        m_axesParams.put( "VGain5=", 0 );
        m_axesParams.put( "ServoErrTolerance(english)=", 1 );
        m_axesParams.put( "ServoErrTolerance(metric)=", 25 );
        m_axesParams.put( "EncoderCounts(english)=", 8192 );
        m_axesParams.put( "EncoderCounts(metric)=", 323 );
        m_axesParams.put( "DriveType=", 0 );
        m_axesParams.put( "DACPolarity=", 0 );
        m_axesParams.put( "EncoderPolarity=", 1 );
