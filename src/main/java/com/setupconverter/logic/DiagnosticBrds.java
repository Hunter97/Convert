...
public final class DiagnosticBrds {
    ...
    private void initializeParamMaps() {
        ...
        m_outputParams.put( "Output4Type=", OUTPUT_NUM.DRIVE_ENABLE.getValue() );
        ...
        m_outputParams.put( "Output40Type=", OUTPUT_NUM.CUT_CONTROL_1.getValue() );
        m_outputParams.put( "Output41Type=", OUTPUT_NUM.CUT_CONTROL_2.getValue() );
